...
## Corruptions
The following corruptions are applied to the images, equivalently to [MNIST-C](https://arxiv.org/abs/1906.02337) :
...
## Credits
- FMNIST-C is inspired by and based on Googles MNIST-C. See the [paper](https://arxiv.org/abs/1906.02337) and [repo](https://github.com/google-research/mnist-c).
